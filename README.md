...
|------|-------------------|---------|------|
| 寄存器分配 | 量子晶格(零冲突) | 线性扫描(MAX_REGS=48) | 待实现量子晶格 |
| 4320D调度 | 螺旋测地线全局最优 | 能量排序+Yamabe流 | 待实现完整测地线 |
| VAVX3 融合 | 512位GPU原生 | HunTian .sabin格式 | 待GPU端展开 |
| 三进制 | TMAD/TMUL硬件 | 指令枚举定义 | 待编码实现 |
